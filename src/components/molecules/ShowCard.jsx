          ...
          <DialogContent  className=' w-full '>
            <div className="flex flex-row gap-9 w-[100%] px-10">
                ...
                <div className="flex flex-col gap-4 w-full">
                  ...
                  <Input typeInput="InputForm" name="No Reg" placeholder="Masukkan NIM/NPM/NIP" type="text" onChange={e => setNoReg(e.target.value)} />
                  <span></span>
    ...
    case "ShowData":
      ...
      <React.Fragment >
        ...
        >
          ...
          <DialogActions className='mr-4 mb-3'>
            <Button type="PrimaryButton" text="Edit Data" className="bg-[#22A5C4] "
              onClick={onClickEdit}
            />
          </DialogActions>
