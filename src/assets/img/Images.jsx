...
import logo from "./BLC-Logo.png";
import vektor1 from "./vektor1.svg";
import vektor2 from "./vektor2.jpg";
...
const Images = (props) => {
  ...
  switch (type) {
    ...
    case "vektor1":
      return <img src={vektor1} alt="" className={className} />;
    case "vektor2":
      return <img src={vektor2} alt="" className={className} />;
    case "profile":
      return (
        <svg
          className={className}
