                        ...
                        data.map((item, i) => {
                            return (
                                <div className="flex px-4 py-2" key={i}>
                                    ...
                                    <label className="inline-flex items-center cursor-pointer mx-4" onClick={handleActiveTest(item.id)}>
                                        
                                            <input type="checkbox" value="" className="sr-only peer" onChange={() => {}} checked={item.status}/>
